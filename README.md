...
## TBD
- [ ] Use Yeoman to make the project structure creator.
- [ ] Prepare base unit test code for base source code files.
- [ ] Replace moment-timezone module with one of the alternatives.
- [ ] Jest(unit test), SuperTest(integration test), semantic-release configuration and documentation.
...
### .gitignore
This project's `.gitignore` file is generated by [.gitignore.io](https://www.toptal.com/developers/gitignore). You can easily generate your `.gitignore` file with it.
